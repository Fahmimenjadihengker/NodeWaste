  ...
  return (
    <div>
      ...
      <div className="mt-6 grid gap-4">
        ...
        <RegionSelect label="Provinsi" value={value.provinceCode} options={provinces} placeholder="Pilih provinsi" onChange={handleProvinceChange} />
        <RegionSelect label="Kabupaten/kota" value={value.cityCode} options={regencies} placeholder="Pilih kabupaten/kota" disabled={!value.provinceCode} onChange={handleCityChange} />
        <RegionSelect label="Kecamatan" value={value.districtCode} options={districts} placeholder="Pilih kecamatan" disabled={!value.cityCode} onChange={handleDistrictChange} />
