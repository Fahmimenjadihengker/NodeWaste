    ...
    <section className="bg-[#f5f1df] px-5 py-20 sm:px-8 lg:px-10">
      <div className="mx-auto grid max-w-7xl gap-8 border-y border-moss/15 py-12 md:grid-cols-[1fr_auto] md:items-center">
        <div className="max-w-2xl">
          <p className="text-sm font-black uppercase tracking-[0.24em] text-leaf-600">Mulai memilah</p>
          <h2 className="mt-3 text-3xl font-black tracking-[-0.04em] text-leaf-900 sm:text-4xl">Siap scan sampah pertamamu dan merawat Leafy?</h2>
        </div>
