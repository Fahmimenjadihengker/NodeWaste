    ...
    >
      <form className="space-y-5" onSubmit={handleSubmit}>
        ...
        <label className="block">
          ...
          <input className="mt-2 w-full rounded-2xl border border-moss/15 bg-white px-4 py-3 font-semibold outline-none transition placeholder:text-moss/35 focus:border-leaf-600" name="password" type="password" value={form.password} onChange={handleChange} placeholder="Minimal 8 karakter" required />
        </label>
        {status.message ? (
